...
const rules = [
  "7v7 Sunday league format with rolling subs and match-day roster check-in.",
  "Players must be registered before kickoff to appear on an official roster.",
  "Standings are based on points, then goal difference, then goals scored.",
  "Captains are responsible for jerseys, communication, and reporting scores.",
  "Unsporting behavior, repeated no-shows, or unpaid balances can remove a team from the league.",
];
